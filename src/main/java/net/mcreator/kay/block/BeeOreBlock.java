...
public class BeeOreBlock extends KayModElements.ModElement {
	@ObjectHolder("kay:bee_ore")
	public static final Block block = null;
	public BeeOreBlock(KayModElements instance) {
		super(instance, 2);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BeeIngotItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("kay:bee_ore_match"), () -> CustomRuleTest.codec);
