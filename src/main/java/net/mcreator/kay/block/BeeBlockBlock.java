...
public class BeeBlockBlock extends KayModElements.ModElement {
	@ObjectHolder("kay:bee_block")
	public static final Block block = null;
	public BeeBlockBlock(KayModElements instance) {
		super(instance, 3);
	}
