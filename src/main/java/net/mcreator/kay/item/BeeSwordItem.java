...
public class BeeSwordItem extends KayModElements.ModElement {
	@ObjectHolder("kay:bee_sword")
	public static final Item block = null;
	public BeeSwordItem(KayModElements instance) {
		super(instance, 9);
	}
